...
Class WiseStrongProphetG Σ `{heap_GS : !heapGS Σ} spec := {
...
#[global] Instance subG_wise_strong_prophet_Σ Σ `{heap_GS : !heapGS Σ} spec :
...
Section make_wise_prophet_G.
  Context `{heap_GS : !heapGS Σ} spec `{wise_prophet_G : !WiseStrongProphetG Σ spec}.
...
Record wise_prophet `{heap_GS : !heapGS Σ} := {
...
Class WiseProphetG Σ `{heap_GS : !heapGS Σ} spec := {
...
#[global] Instance subG_wise_prophet_Σ Σ `{heap_GS : !heapGS Σ} spec :
...
Section make_wise_prophet.
  Context `{heap_GS : !heapGS Σ} spec `{wise_prophet_G : !WiseProphetG Σ spec}.
