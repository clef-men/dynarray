...
Record typed_strong_prophet `{heap_GS : !heapGS Σ} := {
...
Section make_typed_strong_prophet.
  Context `{heap_GS : !heapGS Σ} (spec : typed_strong_prophet_spec).
...
Record typed_prophet `{heap_GS : !heapGS Σ} := {
...
Section make_typed_prophet.
  Context `{heap_GS : !heapGS Σ} (spec : typed_prophet_spec).
...
Record typed_prophet1 `{heap_GS : !heapGS Σ} := {
...
Section make_typed_prophet1.
  Context `{heap_GS : !heapGS Σ} (spec : typed_prophet1_spec).
